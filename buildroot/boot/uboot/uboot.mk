...
ifeq ($(BR2_TARGET_UBOOT_WORKING_DIR),y)
UBOOT_SITE = $(call qstrip,$(BR2_TARGET_UBOOT_WORKING_DIR_VALUE))
UBOOT_SITE_METHOD = link
UBOOT_EXTRACT_CMDS = 
UBOOT_VERSION = working
UBOOT_SOURCE = uboot-$(UBOOT_VERSION)
