...
SAMBA30_UNINSTALL_TARGET_OPT = \
	DESTDIR=$(TARGET_DIR) -C $(SAMBA30_DIR)/$(SAMBA30_SUBDIR) \
	uninstallclientlib uninstallservers uninstallbin uninstallscripts \
...
SAMBA30_BINTARGETS_$(BR2_PACKAGE_SAMBA30_SMBD) += usr/sbin/smbd
...
SAMBA30_BINTARGETS_$(BR2_PACKAGE_SAMBA30_SMBTA_UTIL) += usr/bin/smbta-util
...
ifeq ($(BR2_PACKAGE_SAMBA30_LIBICONV),y)
SAMBA30_DEPENDENCIES += libiconv
SAMBA30_CONF_OPT += --with-libiconv=$(STAGING_DIR)
else
SAMBA30_CONF_OPT += --with-libiconv=""
endif
...
define SAMBA30_BUILD_CMDS 
	cd $(@D)/source && make proto
	cd $(@D)/source && make all
endef
