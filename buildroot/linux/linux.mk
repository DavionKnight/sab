...
else ifeq ($(BR2_LINUX_KERNEL_WORKING_DIR),y)
LINUX_SITE = $(call qstrip,$(BR2_LINUX_KERNEL_WORKING_DIR_VALUE))
LINUX_SITE_METHOD = link
LINUX_EXTRACT_CMDS = 
LINUX_VERSION = work
LINUX_SOURCE = linux-$(LINUX_VERSION)
else
...
define LINUX_CONFIGURE_CMDS
	cp $(KERNEL_SOURCE_CONFIG) $(KERNEL_ARCH_PATH)/configs/buildroot_defconfig
		## p4 checkins by default is READ only ; not good for this
		chmod +w $(KERNEL_ARCH_PATH)/configs/buildroot_defconfig
