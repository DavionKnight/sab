...
#if (defined(CONFIG_MVS) && CONFIG_MVS < 2) || defined(CONFIG_R360MPI) || \
	defined(CONFIG_RBC823)  || defined(CONFIG_TQM823L) || defined(CONFIG_TQM823M) || \
	defined(CONFIG_TQM850L) || defined(CONFIG_TQM850M) || defined(CONFIG_TQM885D) || \
	defined(CONFIG_ETX094)  || defined(CONFIG_RRVISION)|| defined(CONFIG_VIRTLAB2)|| \
...
#if defined(CONFIG_TQM855L) || defined(CONFIG_TQM855M) || defined(CONFIG_TQM860L) || \
	defined(CONFIG_TQM860M) || defined(CONFIG_TQM862L) || defined(CONFIG_TQM862M) || \
