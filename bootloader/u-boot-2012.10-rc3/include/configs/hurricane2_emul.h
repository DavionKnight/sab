...
//#define CONFIG_PHYS_SDRAM_1_SIZE			0x20000 //0x01000000 /* 16 MB */
#define CONFIG_PHYS_SDRAM_1_SIZE			0x08000000 //0x01000000 /* 16 MB */
...
#else
#define CONFIG_SYS_STACK_SIZE		(0x00008000) /* 32K */       
#endif
...
#define IPROC_ARM_CLK		(92872)	/* Fix me: Modify these values as per emulation clocks */
#define IPROC_AXI_CLK		(232183)
#define IPROC_APB_CLK		(48015)  /* 100 MHz */
#endif
/* Serial Info */
