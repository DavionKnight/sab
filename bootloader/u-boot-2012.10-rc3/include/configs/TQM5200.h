...
#if !defined(CONFIG_CAM5200) && !defined(CONFIG_CHARON) && !defined(CONFIG_FO300)
...
/* USB */
#if defined(CONFIG_CHARON) || defined(CONFIG_FO300) || defined(CONFIG_STK52XX)
...
#if defined(CONFIG_CHARON) || defined(CONFIG_FO300) || defined(CONFIG_MINIFAP) || \
