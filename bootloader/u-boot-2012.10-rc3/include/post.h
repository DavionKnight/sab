...
#define CONFIG_SYS_POST_NAND                0x00000001
#define CONFIG_SYS_POST_QSPI                0x00000002
#define CONFIG_SYS_POST_MEMORY		        0x00000004
#define CONFIG_SYS_POST_SPI                 0x00000008
#define CONFIG_SYS_POST_UART		        0x00000010
#define CONFIG_SYS_POST_ETHER               0x00000020

#ifdef IPROC_BOARD_DIAGS
#define CONFIG_SYS_POST_PWM                 0x00000100
#define CONFIG_SYS_POST_GPIO                0x00000200
#define CONFIG_SYS_POST_GSIO_SPI            0x00000400
#define CONFIG_SYS_POST_I2C                 0x00000800
#define CONFIG_SYS_POST_PCIE                0x00001000
#define CONFIG_SYS_POST_MMC                 0x00002000
#define CONFIG_SYS_POST_I2S                 0x00004000
#define CONFIG_SYS_POST_I2S_W8955           0x00008000
#define CONFIG_SYS_POST_RGMII               0x00010000
#define CONFIG_SYS_POST_SATA                0x00020000
#define CONFIG_SYS_POST_USB20               0x00040000
#define CONFIG_SYS_POST_USB30               0x00080000
#define CONFIG_SYS_POST_SPDIF               0x00100000
#define CONFIG_SYS_POST_VOIP                0x00200000
#define CONFIG_SYS_POST_EMMC                0x00400000
#define CONFIG_SYS_POST_SGMII               0x00800000
#define CONFIG_SYS_POST_PVTMON              0x01000000
#else /* IPROC_BOARD_DIAGS */
#define CONFIG_SYS_POST_RTC		            0x00000100
#define CONFIG_SYS_POST_WATCHDOG	        0x00000200
#define CONFIG_SYS_POST_CPU		            0x00000400
#define CONFIG_SYS_POST_I2C		            0x00000800
#define CONFIG_SYS_POST_CACHE		        0x00001000
#define CONFIG_SYS_POST_USB		            0x00002000
#define CONFIG_SYS_POST_SPR		            0x00004000
#define CONFIG_SYS_POST_SYSMON		        0x00008000
#define CONFIG_SYS_POST_DSP		            0x00010000
#define CONFIG_SYS_POST_OCM		            0x00020000
#define CONFIG_SYS_POST_FPU		            0x00040000
#define CONFIG_SYS_POST_ECC		            0x00080000
#define CONFIG_SYS_POST_BSPEC1		        0x00100000
#define CONFIG_SYS_POST_BSPEC2		        0x00200000
#define CONFIG_SYS_POST_BSPEC3		        0x00400000
#define CONFIG_SYS_POST_BSPEC4		        0x00800000
#define CONFIG_SYS_POST_BSPEC5		        0x01000000
#define CONFIG_SYS_POST_CODEC		        0x02000000
#define CONFIG_SYS_POST_COPROC		        0x04000000
#define CONFIG_SYS_POST_FLASH		        0x08000000
#define CONFIG_SYS_POST_MEM_REGIONS	        0x10000000
#endif /* IPROC_BOARD_DIAGS */
