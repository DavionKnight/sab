...
static void mmc_reset_controller_fsm(struct hsmmc *mmc_base, u32 bit)
{
	 ...
	 */
#if defined(CONFIG_OMAP44XX) || defined(CONFIG_OMAP54XX) || defined(CONFIG_AM33XX)
...
#if (defined(CONFIG_OMAP44XX) || defined(CONFIG_OMAP54XX) || defined(CONFIG_DRA7XX) || \
	defined(CONFIG_AM57XX)) && defined(CONFIG_HSMMC2_8BIT)
